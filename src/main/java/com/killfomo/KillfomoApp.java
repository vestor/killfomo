...
public class KillfomoApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(KillfomoApp.class);

    private final Environment env;

    public KillfomoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes killfomo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KillfomoApp.class);
