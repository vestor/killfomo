...
public class Freshdesk {
    ...
    public void fetchTaskForUser(Long userId) throws IOException {
        ...
        AuthResource authResource = authResourceService.findByUserIdAndTaskType(userId, TaskType.FRESHDESK);
    ...
    private void fetchTasksFromFreshservice(Long userId, Map rawTokenInfo) throws IOException {
        ...
        String url = BASE_URL.replace("{domain}", domain)  + "/api/v2/tickets.json?requester_id";
